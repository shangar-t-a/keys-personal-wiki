...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x0bgreet.proto\x12\x05greet\".\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x10\n\x08greeting\x18\x02 \x01(\t\"\x1d\n\nHelloReply\x12\x0f\n\x07message\x18\x01 \x01(\t\"E\n\x0c\x44\x65layedReply\x12\x0f\n\x07message\x18\x01 \x01(\t\x12$\n\x07request\x18\x02 \x03(\x0b\x32\x13.greet.HelloRequest2\x80\x02\n\x07Greeter\x12\x32\n\x08SayHello\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReply\x12:\n\x0eParrotSayHello\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReply0\x01\x12\x42\n\x14\x43hattyClientSayHello\x12\x13.greet.HelloRequest\x1a\x13.greet.DelayedReply(\x01\x12\x41\n\x13InteractiveSayHello\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReply(\x01\x30\x01\x62\x06proto3')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GREETER']._serialized_end=429

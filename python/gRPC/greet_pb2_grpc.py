...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ParrotSayHello = channel.unary_stream(
                '/greet.Greeter/ParrotSayHello',
                request_serializer=greet__pb2.HelloRequest.SerializeToString,
                response_deserializer=greet__pb2.HelloReply.FromString,
                _registered_method=True)
        self.ChattyClientSayHello = channel.stream_unary(
                ...
                _registered_method=True)
        self.InteractiveSayHello = channel.stream_stream(
                '/greet.Greeter/InteractiveSayHello',
                request_serializer=greet__pb2.HelloRequest.SerializeToString,
                response_deserializer=greet__pb2.HelloReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ParrotSayHello': grpc.unary_stream_rpc_method_handler(
                    servicer.ParrotSayHello,
                    request_deserializer=greet__pb2.HelloRequest.FromString,
                    response_serializer=greet__pb2.HelloReply.SerializeToString,
            ),
            ...
            'InteractiveSayHello': grpc.stream_stream_rpc_method_handler(
                    servicer.InteractiveSayHello,
                    request_deserializer=greet__pb2.HelloRequest.FromString,
                    response_serializer=greet__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    @staticmethod
    def InteractiveSayHello(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
